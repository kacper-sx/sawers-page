  ...
  const howWeWorkData: WorkData[] = [
    {
      ...
      outsideIcon: isMobile ? (
        <MoveDown className='w-8 h-8 lg:w-16 lg:h-16 text-sawers-sun' />
      ) : (
        <MoveRight className='w-8 h-8 lg:w-16 lg:h-16 text-sawers-sun ' />
      ),
    },
    {
      title: 'Wycena',
      ...
      outsideIcon: isMobile ? (
        ...
        <MoveRight className='w-8 h-8 lg:w-16 lg:h-24 text-sawers-sun' />
      ),
    },
    {
      title: 'Realizacja',
