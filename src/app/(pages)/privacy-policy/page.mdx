...
- **Serwis** - serwis internetowy "sawers.pl" działający pod adresem [https://sawers.pl](https://sawers.pl)
- **Serwis zewnętrzny** - serwisy internetowe partnerów, usługodawców lub usługobiorców współpracujących z Administratorem
- **Administrator Serwisu / Danych** - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest firma "Sawers Saweczko Robert", prowadząca działalność pod adresem: ul. 11 Listopada 66/23 21-200 Parczew, o nadanym numerze identyfikacji podatkowej (NIP): 9541523286.
...
**Powierzenie przetwarzania danych osobowych - Usługi Hostingu, Mailingu, VPS lub Serwerów Dedykowanych**

Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, mailingu, VPS lub Serwerów Dedykowanych - **Netlify, Inc.** oraz **Plus Five Five, Inc. (Resend)**. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej poza obrębem granic Unii Europejskiej. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.
...
- **Adres pocztowy** - Sawers Saweczko Robert 11 Listopada 66/23 21-200 Parczew
- **Adres poczty elektronicznej** - [ser2332@wp.pl](mailto:ser2332@wp.pl)
- **Połączenie telefoniczne** - [+48 606136448](tel:+48606136448)
- **Formularz kontaktowy** - dostępny pod adresem: [sawers.pl/contact](https://sawers.pl/contact)
