...
export const HeroOpacityBg = ({
  ...
  return (
    <div className="relative w-full flex-col flex overflow-y-hidden lg:min-h-screen justify-center pt-28 pb-12 lg:pb-0 lg:pt-[100px] gap-12 items-center bg-background-photo px-5 lg:px-[250px]">
      <Image
        src={src}
        alt="hero opacity bg"
      ...
      <div>
        <IoMdArrowRoundDown className="text-sawers-blue lg:w-16 lg:h-16 w-8 h-8  animate-bounce" />
      </div>
    </div>
  );
};
